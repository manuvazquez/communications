...
,_startDetectionTime(_preamble.cols())
{
	...
	for (uint iOutput=0;iOutput<_nOutputs;iOutput++)
		for(uint iChannelOrder=0;iChannelOrder<_candidateOrders.size();iChannelOrder++)
