 ...
 ***************************************************************************/
#include "TesisEstimacionConjuntaCanalBesselSystem.h"

TesisEstimacionConjuntaCanalBesselSystem::TesisEstimacionConjuntaCanalBesselSystem()
...
//     }else
//         throw RuntimeException("TesisEstimacionConjuntaCanalBesselSystem::TesisEstimacionConjuntaCanalBesselSystem: memory has to be 3 or 6.");
...
void TesisEstimacionConjuntaCanalBesselSystem::AddAlgorithms()
{
...
void TesisEstimacionConjuntaCanalBesselSystem::BuildChannel()
{
...
void TesisEstimacionConjuntaCanalBesselSystem::BeforeEndingFrame(int iFrame)
{
