 ...
 ***************************************************************************/
#ifndef TESISORDENCANALMEDIANTESISSYSTEM_H
#define TESISORDENCANALMEDIANTESISSYSTEM_H
...
class TesisOrdenCanalMedianteSISSystem : public ChannelOrderEstimationSystem
{
protected:
    int nSurvivors;
...
public:
    TesisOrdenCanalMedianteSISSystem();
