...
TesisOrdenCanalSystem::TesisOrdenCanalSystem()
...
void TesisOrdenCanalSystem::BuildChannel()
{
...
void TesisOrdenCanalSystem::AddAlgorithms()
{
...
void TesisOrdenCanalSystem::BeforeEndingFrame(int iFrame)
{
