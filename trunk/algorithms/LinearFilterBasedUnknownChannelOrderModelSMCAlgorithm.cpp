...
,_canal(canal),_simbolos(simbolos)
{
    if(linearDetectors.size()!=_candidateOrders.size())
        throw RuntimeException("LinearFilterBasedUnknownChannelOrderModelSMCAlgorithm::LinearFilterBasedUnknownChannelOrderModelSMCAlgorithm: nº of detectors and number of channel matrix estimators (and candidate orders) are different.");
