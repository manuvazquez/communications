 ...
 ***************************************************************************/
#ifndef STOCHASTICPSPALGORITHM_H
#define STOCHASTICPSPALGORITHM_H
...
class StochasticPSPAlgorithm : public KnownChannelOrderAlgorithm
{
private:
...
//     PSPPath **_exitStage, **_arrivalStage;
    std::vector<PSPPath> *_exitStage, *_arrivalStage;
