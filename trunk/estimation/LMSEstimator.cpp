...
LMSEstimator::LMSEstimator(const tMatrix &initialEstimation,double mu): ChannelMatrixEstimator(initialEstimation),_mu(mu),_predictedObservations(_L),_error(_L),_deltaMatrix(_L,_Nm)
{
}
