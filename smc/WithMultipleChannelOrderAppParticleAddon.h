...
#ifndef WITHMULTIPLECHANNELORDERAPPPARTICLEADDON_H
#define WITHMULTIPLECHANNELORDERAPPPARTICLEADDON_H

#include <WithChannelOrderAppParticleAddon.h>
#include <vector>

class WithMultipleChannelOrderAppParticleAddon
{
protected:
  std::vector<WithChannelOrderAppParticleAddon> _channelOrderAppParticleAddons;
public: 
