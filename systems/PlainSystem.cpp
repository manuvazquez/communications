...
// 	_augmentedObservationsKalmanEstimator = new AugmentedObservationsKalmanEstimator(_powerProfile->means(),_powerProfile->variances(),_N,_ARcoefficients,_ARvariance);
...
// 	delete _augmentedObservationsKalmanEstimator;
...
{
	_algorithms.push_back(new LinearFilterBasedAlgorithm("MMSE + KF",*_alphabet,_L,_L,_N,_iLastSymbolVectorToBeDetected,_m,_kalmanEstimator,_preamble,_d,_MMSEdetector,_ARcoefficients));
	_algorithms.push_back(new LinearFilterBasedAlgorithm("MMSE + KF with IC",*_alphabet,_L,_L,_N,_iLastSymbolVectorToBeDetected,_m,_kalmanEstimator,_preamble,_d,_ICMMSEdetector,_ARcoefficients,true));
...
// 	_algorithms.push_back(new KalmanFilterAwareMMSEBasedAlgorithm("KF-aware MMSE + Known SER Kalman Filter",*_alphabet,_L,_L,_N,_iLastSymbolVectorToBeDetected,_m,_SERawareKalmanEstimatorDecorator,_preamble,_d,_kalmanFilterAwareMMSEDetector,_ARcoefficients));
	...
	_algorithms.push_back(new LinearFilterBasedAlgorithm("MMSE + Known Symbols KF",*_alphabet,_L,_L,_N,_iLastSymbolVectorToBeDetected,_m,_knownSymbolsKalmanEstimator,_preamble,_d,_MMSEdetector,_ARcoefficients));
