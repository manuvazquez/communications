...
TimeInvariantChannel::TimeInvariantChannel(uint nInputs, uint nOutputs, int memory, uint length, MatrixXd channelMatrix): StillMemoryMIMOChannel(nInputs, nOutputs, memory, length),_channelMatrix(channelMatrix)
{
