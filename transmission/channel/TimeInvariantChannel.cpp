...
TimeInvariantChannel::TimeInvariantChannel(uint nInputs, uint nOutputs, uint memory, uint length, MatrixXd channelMatrix): StillMemoryMIMOChannel(nInputs, nOutputs, memory, length),_channelMatrix(channelMatrix)
{
